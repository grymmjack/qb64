'** Demo - Bouncing Ball 2
'**        Using a TYPE definition
'**        Removed IFs to print direction of ball
'**        Speed controlled with arrow keys
...
Ball.speed = 10 '                                         set the ball speed
...
Ball.radius = 25 '                                        set the ball radius
...
DO '                                                      begin main loop
    ...
    LOCATE 6, 2
    PRINT "RIGHT ARROW increase speed, LEFT ARROW decrease speed."
    IF _KEYDOWN(19712) THEN '                             right arrow key?
        Ball.speed = Ball.speed + 1 '                     yes, increase ball speed
    ELSEIF _KEYDOWN(19200) THEN '                         left arrow key?
        Ball.speed = Ball.speed - 1 '                     yes, decrease ball speed
    END IF
    IF Ball.speed < 1 THEN Ball.speed = 1 '               keep ball speed within limits
    IF Ball.speed > 20 THEN Ball.speed = 20
